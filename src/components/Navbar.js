...
export default function Navbar() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <nav
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md text-[#997736] " : "bg-transparent text-white"
          }`}
      >
        <div className="container mx-auto flex items-center justify-between px-4 py-3">
          <div className="space-x-8 flex items-center">
            ...
            <div className="hidden md:flex items-center gap-6 font-medium">
              <a href="#home" className={`transition-colors duration-300 ${isScrolled ? "hover:text-[#997736]/70" : "hover:text-[#997736]"}`}>
                HOME
              </a>
              <a href="#about" className={`transition-colors duration-300 ${isScrolled ? "hover:text-[#997736]/70" : "hover:text-[#997736]"}`}>
                ABOUT
              </a>
              <a
                href="#site-floor-plans"
                className={`transition-colors duration-300 ${isScrolled ? "hover:text-[#997736]/70" : "hover:text-[#997736]"}`}
              >
                SITE & FLOOR PLANS
              </a>
              <a
              ...
              <a href="#gallery" className={`transition-colors duration-300 ${isScrolled ? "hover:text-[#997736]/70" : "hover:text-[#997736]"}`}>
                GALLERY
              </a>
              <a
                href="#location"
              ...
              <a href="#contact" className={`transition-colors duration-300 ${isScrolled ? "hover:text-[#997736]/70" : "hover:text-[#997736]"}`}>
                CONTACT
              </a>
              <button onClick={openModal} className="bg-red-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-red-700 transition-colors">
                Download Brochure
              </button>
            </div>
          </div>
